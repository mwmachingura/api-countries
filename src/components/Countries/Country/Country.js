...
const Country = ({ country, dark }) => {
    return (
        <div className={`w-72 overflow-hidden shadow-lg h-auto ${(dark) ? 'bg-dark-blue text-white': 'bg-white text-dark-blue-text'}`}>
            ...
            <div className='h-40 px-2'>
                ...
                <div className='flex flex-col items-start'>
                    <h4 className='font-semibold text-sm py-1'>Population: <span className='font-light'>{country.population}</span></h4>
